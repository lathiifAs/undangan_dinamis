                            ...
                            <div id="carouselExampleControls" class="carousel slide mb-4" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="<?php echo e(URL('public_template/assets/img/banner/islamic_center.jpg')); ?>"
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?php echo e(URL('public_template/assets/img/banner/pulau_biawak2.jpg')); ?>"
                                            height="500px" class="d-block w-100" alt="">
                                        <div class="carousel-caption d-none d-md-block mt-5">
                            ...
                            <div class="trending-bottom">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?php echo e(URL('public_template/assets/img/trending/tari_topeng.jpg')); ?>"
                                                    height="240" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                                <span class="color1">Budaya</span>
                                                <h4><a href="details.html">Tari Topeng Kelana.</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?php echo e(URL('public_template/assets/img/trending/pindang_gombyang.jpg')); ?>"
                                                    height="240" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?php echo e(URL('public_template/assets/img/trending/tpi.jpg')); ?>"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                        ...
                        <div class="col-12">
                            <div class="recent-active dot-style d-flex dot-style">
                                <div class="single-recent mb-100">
                                    <div class="what-img">
                                        <img src="<?php echo e(URL('public_template/assets/img/news/recent1.jpg')); ?>" alt="">
                                    </div>
                                    <div class="what-cap">
                                ...
                                <div class="single-recent mb-100">
                                    <div class="what-img">
                                        <img src="<?php echo e(URL('public_template/assets/img/news/recent2.jpg')); ?>" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <span class="color1">Night party</span>
                                        <h4><a href="#">Welcome To The Best Model Winner Contest</a></h4>
                                ...
                                <div class="single-recent mb-100">
                                    <div class="what-img">
                                        <img src="<?php echo e(URL('public_template/assets/img/news/recent3.jpg')); ?>" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <span class="color1">Night party</span>
                                        <h4><a href="#">Welcome To The Best Model Winner Contest</a></h4>
