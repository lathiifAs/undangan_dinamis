                ...
                <div class="weekly-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-tittle mb-30">
                                <div class="row">
                                    <h3 class="mr-4">Anggaran Desa</h3> <button class="genric-btn info medium" data-toggle="modal" data-target="#exampleModalLong">Detail Anggaran</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table border="1" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong>Rp&nbsp;</strong><strong>35,977,500 </strong></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong>Rp 1,007,069,000 </strong></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong>Rp 1,043,046,500 </strong></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table align="left" border="1" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong>Rp 1,069,527,377 </strong></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <p>
                                                <strong>Rp 1,067,666,879 </strong></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
