                        ...
                        <article class="blog_item">
                            ...
                            <div class="blog_details row">
                                <div class="card m-3" style="width: 18rem;">
                                    <img class="card-img-top" src="{{ URL('public_template/assets/img/sd/sd.jpg') }}" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">SD A</h5>
