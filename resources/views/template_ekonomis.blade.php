...
<head>
    ...
    <!-- <link rel="shortcut icon" type="image/x-icon" href="{{ URL('template_ekonomis/img/favicon.png') }}"> -->
    <!-- Place favicon.ico in the root directory -->

    <!-- CSS here -->
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/nice-select.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/gijgo.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/slicknav.css') }}">
    <link rel="stylesheet" href="{{ URL('template_ekonomis/css/style.css') }}">
    <!-- <link rel="stylesheet" href="{{ URL('template_ekonomis/css/responsive.css') }}"> -->
</head>
...
<body>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="{{ URL('template_ekonomis/img/logo.png') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-9 col-lg-9">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="active" href="#undangan">Undangan</a></li>
                                        <li><a href="story.html">Foto Prewedding</a></li>
                                        <li><a href="Gallery.html">Rekening</a></li>
                                        <li><a href="contact.html">Ucapkan Sesuatu</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="slider_area_inner slider_bg_1 overlay2">
            <div class="slider_text text-center">
                <div class="text_inner">
                    <img src="{{ URL('template_ekonomis/img/banner/ornaments.png') }}" alt="">
                    <h4>14 Jan 2020</h4>
                    <h3>{{ $data->nama_panggilan_wanita }} & {{ $data->nama_panggilan_laki }} <br>
                        Wedding Ceremony</h3>
    ...
    <div class="weeding_countdown_area">
        <div class="flowaers_top d-none d-lg-block">
            <img src="{{ URL('template_ekonomis/img/banner/flower-top.png') }}" alt="">
        </div>
        <div class="flowaers_bottom d-none d-lg-block">
                <img src="{{ URL('template_ekonomis/img/banner/flower-bottom.png') }}" alt="">
            </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center">
                        <img src="{{ URL('template_ekonomis/img/banner/flowers.png') }}" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="{{ URL('template_ekonomis/img/story/1.png') }}" alt="">
                        </div>
                        <span>Groom</span>
                        <h3>Jack Wonner</h3>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="{{ URL('template_ekonomis/img/story/2.png') }}" alt="">
                        </div>
                        <span>Bride</span>
                        <h3>Anjelina Kona</h3>
                        <p>Many variations of passages of Lorem Ipsum available, but the majority have suffered
            ...
            <div class="row grid no-gutters">
                <div class="col-xl-4 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_1">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/1.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_2">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/2.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_3">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/3.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_4">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/4.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_5">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/5.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_6">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/6.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_7">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/7.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_8">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/8.png') }}">
                        </a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_9">
                        <a class="popup-image" href="{{ URL('template_ekonomis/img/gallery/9.png') }}"></a>
                    </div>
                </div>
            </div>
            <!-- <div class="grid row">
                <div class="single_image grid-item">
                    <img src="{{ URL('template_ekonomis/img/gallery/1.png') }}" alt="">
                </div><div class="single_image grid-item">
                    <img src="{{ URL('template_ekonomis/img/gallery/2.png') }}" alt="">
                </div><div class="single_image grid-item">
                    <img src="{{ URL('template_ekonomis/img/gallery/3.png') }}" alt="">
                </div>
            </div> -->
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single_program program_bg_1 text-center">
                        <div class="program_inner ">
                            ...
                            <img src="{{ URL('template_ekonomis/img/program_details/ornaments.png') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4">
                ...
                <div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                    <div class="main_attending_area">
                        <div class="flower_1 d-none d-lg-block">
                            <img src="{{ URL('template_ekonomis/img/appointment/flower-top.png') }}" alt="">
                        </div>
                        <div class="flower_2 d-none d-lg-block">
                            <img src="{{ URL('template_ekonomis/img/appointment/flower-bottom.png') }}" alt="">
                        </div>
...
<!-- footer_end -->
    ...
    <!-- JS here -->
    <script src="{{ URL('template_ekonomis/js/vendor/modernizr-3.5.0.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/vendor/jquery-1.12.4.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/popper.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/bootstrap.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/owl.carousel.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/isotope.pkgd.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/ajax-form.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/waypoints.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/scrollIt.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.scrollUp.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/wow.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/nice-select.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/gijgo.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.countdown.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.slicknav.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/plugins.js') }}"></script>

    <!--contact js-->
    <script src="{{ URL('template_ekonomis/js/contact.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.ajaxchimp.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.form.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/jquery.validate.min.js') }}"></script>
    <script src="{{ URL('template_ekonomis/js/mail-script.js') }}"></script>

    <script src="{{ URL('template_ekonomis/js/main.js') }}"></script>
